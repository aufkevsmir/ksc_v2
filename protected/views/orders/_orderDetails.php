            ...
            <table class="table table-bordered mb-4">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $model->shipping_address ? nl2br(CHtml::encode($model->shipping_address)) : '<em>Not provided</em>' ?></td>
                    </tr>
                    <tr>
                        <th>Paid At</th>
            ...
            <?php if (!empty($showActions)): ?>
                <div class="mt-4 d-flex gap-2 flex-wrap">
                    ...
                    <?php if ($model->status === 'pending' && $isBuyer): ?>
                        <a href="<?= $this->createUrl('stripe/checkout', ['orderId' => $model->id]) ?>"
                    ...
                    <?php if ($isBuyer || $isSeller): ?>
                        <a href="<?= $this->createUrl('orders/print', ['id' => $model->id]) ?>"
                           target="_blank"
