...
class Transactions extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('stripe_session_id, stripe_payment_intent', 'length', 'max'=>100),
			array('amount', 'length', 'max'=>10),
			array('paid_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, order_id, stripe_session_id, stripe_payment_intent, amount, paid_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('stripe_session_id',$this->stripe_session_id,true);
		$criteria->compare('stripe_payment_intent',$this->stripe_payment_intent,true);
